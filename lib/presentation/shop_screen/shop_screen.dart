...
import 'package:2072042_s_application1/widgets/app_bar/appbar_subtitle.dart';
...
class ShopScreen extends GetWidget<ShopController> {
                            ...
                            child: Padding(
                                ...
                                child: InkWell(
                                    ...
                                    child: CommonImageView(
                                        imagePath: ImageConstant.imgText112,
                                        height: getVerticalSize(158.00),
                                                                              ...
                                                                              child: Padding(
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                    ...
                                                                                    Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                      ...
                                                                                      Padding(padding: getPadding(left: 40), child: CommonImageView(svgPath: ImageConstant.imgMenu, height: getSize(24.00), width: getSize(24.00)))
                                                                                    ])
                                                                                  ]))),
                                                                          Align(
                                                                              ...
                                                                              child: Padding(
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                    GestureDetector(
                                                                                        ...
                                                                                        child: Text("lbl_consult2".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtExo2Medium12)),
                                                                                    GestureDetector(
                                                                                        onTap: () {
                                                                                          onTapTxtArticle2();
                                                                                        },
  ...
  onTapImgRectangleEleven() {
    Get.toNamed(AppRoutes.shopDetailScreen);
  }
