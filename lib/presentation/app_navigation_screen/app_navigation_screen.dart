...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapArtikelBathdogOne() {
    Get.toNamed(AppRoutes.artikelBathDogOneScreen);
  }
  ...
  onTapVisittoko() {
    Get.toNamed(AppRoutes.visitTokoScreen);
  }
}
