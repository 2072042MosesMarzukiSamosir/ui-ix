import '../visit_toko_guest_screen/widgets/gridrectangleeleven_item_widget.dart';
import '../visit_toko_guest_screen/widgets/listrectangleeleven_four_item_widget.dart';
...
import 'package:2072042_s_application1/widgets/app_bar/appbar_circleimage.dart';
import 'package:2072042_s_application1/widgets/app_bar/appbar_image.dart';
import 'package:2072042_s_application1/widgets/app_bar/appbar_title.dart';
import 'package:2072042_s_application1/widgets/app_bar/custom_app_bar.dart';
import 'package:flutter/material.dart';

class VisitTokoGuestScreen extends GetWidget<VisitTokoGuestController> {
  @override
                                  ...
                                  children: [
                                    Obx(() => GridView.builder(
                                        ...
                                        itemCount: controller
                                            .visitTokoGuestModelObj
                                            .value
                                            .gridrectangleelevenItemList
                                            .length,
                                        itemBuilder: (context, index) {
                                          GridrectangleelevenItemModel model =
                                              controller
                                                      .visitTokoGuestModelObj
                                                      .value
                                                      .gridrectangleelevenItemList[
                                                  index];
                                          return GridrectangleelevenItemWidget(
                                              model,
                                    ...
                                    Padding(
                                        ...
                                        child: Obx(() => ListView.builder(
                                            ...
                                            itemCount: controller
                                                .visitTokoGuestModelObj
                                                .value
                                                .listrectangleelevenFourItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              ListrectangleelevenFourItemModel
                                                  model = controller
                                                          .visitTokoGuestModelObj
                                                          .value
                                                          .listrectangleelevenFourItemList[
                                                      index];
                                              return ListrectangleelevenFourItemWidget(
                                                  model,
